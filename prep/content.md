...
#### context 
* For context on those confused why I'm researching all this will give an explanation as to why. I am a student at a high school who is in a program called the SEP program. This program teaches students the basics and importance of coding and also its use in our modern world. The program is split into 2 separate courses with the first being sep10/the course im in which focuses on the basics on creating a website and the second being sep11 which focuses on the separate parts of computer science which consist of learning to use javascript to create games or as a way to memorize a list of items. Sometimes during mondays we are given time to work on our freedom project which involves choosing a topic that you may be passionate about through the use researching your specific topic. After that research is done then the Process of researching existing topics and future technological advancements begins. I ended up choosing the topic on animal conservation from my research and now I have been able to research all existing and future technologies being made towards animal conservation.

#### overview
* This content.md file will go over the research that I have made on animal conservation and give a quick overview on the research I have made on both existing software and hardware advancements for animal conservation and also research and brainstorm any possible ideas that I may have on future developments in animal conservation.
   
## Part A: existing software and hardware for animal conservation 

### Software advancements for animal conservation

<!--organized the software apps by when it was created and the development of specific technologies-->
<!--included a pros & cons section for each software app I looked up and found-->
...
#### pros 
* app is alot more recent so there may be more changes made on the app interface and the website
* The app is very acsessible and is availible on all platforms
...
#### Pros 
* The acsessibility on all devices makes it possible for more global initiative made on animal conservation and on its developments.
* Although the app isnt very modern alot of changes have been made to the website interface and the apps to make.

#### Cons 
* The usage of the app is mainly focused and aimed towards conservationalists who are apart of different regions such as africa within the safari so not everyone can use the app.
...
<!--I decided to organize the hardware advancements the same as the software advancements in terms of when they were created-->
<!--added more headings to organize the different hadware advancements-->
...
#### Enviornmental DNA and Genomics 

* One hardware advancement that was most interesting was the use of **environmental DNA and genomics** because it was surprising how advanced that the animal conservation industry was already but so many people don't know about it.
...
* I then found another interesting invention called the **camera trap** because although the name sounds pretty menacing it's actually really useful. 
  ...
  * Heres what the camera trap looks like:
...
* The last Hardware advancement  that I found useful was the use of **drones** to scan out environments
  ...
  * heres an image of the drone scanning a group of deers:
    
  <img width="600" height="800" alt="image" src="https://github.com/user-attachments/assets/c6695b01-7a7b-4eaf-8f4d-901ebd5a834f"/>
